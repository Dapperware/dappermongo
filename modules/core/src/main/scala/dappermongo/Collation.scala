...
object Collation {
  sealed abstract class CaseFirst(private[dappermongo] val value: JCollationCaseFirst)
  object CaseFirst {
  ...
  sealed abstract class Alternate(private[dappermongo] val value: JCollationAlternate)
  object Alternate {
  ...
  sealed abstract class MaxVariable(private[dappermongo] val value: JCollationMaxVariable)
  object MaxVariable {
